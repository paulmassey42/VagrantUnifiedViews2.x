...
apt-get -y --force-yes install unifiedviews-mysql=${VERSION} \
	unifiedviews-backend-shared=${VERSION} unifiedviews-backend-mysql=${VERSION} \
	unifiedviews-backend=${VERSION} unifiedviews-webapp-shared=${VERSION} \
	unifiedviews-webapp-mysql=${VERSION} unifiedviews-webapp=${VERSION} \
