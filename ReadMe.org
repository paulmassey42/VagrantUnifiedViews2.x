...
Download "ojdbc7.jar" from the Oracle site and place it in this 
directory.

* Vagrant Machine for Unified Views 2.0.1
...
- access http://localhost:28080/unifiedviews  (Not working)
